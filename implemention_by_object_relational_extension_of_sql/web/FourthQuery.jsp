                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-dashboard"></i> 4th query
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <tbody>
                                 <%
                                        String FourthQuery = "SELECT c1.contestant_name, c2.contestant_name" + 
                                            " FROM contestant c1, contestant c2" +
                                            " WHERE c1.contestant_id != c2.contestant_id AND" +
                                            " NOT c2_performed_piece_c1_didnt(c1, c2);";
                                        ResultSet myResultSet = DBConnection.ExecQuery(FourthQuery);
