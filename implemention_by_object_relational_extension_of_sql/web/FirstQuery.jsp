                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-dashboard"></i> 1st Query
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <tbody>
                                 <%
                                    String FirstQuery = "SELECT cid2cname(a1.contestant), cid2cname(a2.contestant)"+
                                                        " FROM audition a1, audition a2" +
                                                        " WHERE a1.contestant != a2.contestant AND" + 
							" a1.piece = a2.piece AND" +
                                                        " a1.show = a2.show AND" +
                                                        " received_same_score(a1, a2) AND" + 
                                                        " a1.contestant > a2.contestant;";
                                    
                                        ResultSet myResultSet = DBConnection.ExecQuery(FirstQuery);
