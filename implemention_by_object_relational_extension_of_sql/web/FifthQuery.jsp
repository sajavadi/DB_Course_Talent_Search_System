                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-dashboard"></i> 5th query
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <tbody>
                                 <%
                                        String FifthQuery = "WITH RECURSIVE chained_coauditions(c1id, c2id) AS" +
                                                " (SELECT * FROM coauditions " +
                                                " UNION ALL" + 
                                                " SELECT c.c1id, cc.c2id" + 
                                                " FROM coauditions c, chained_coauditions cc" + 
                                                " WHERE c.c2id = cc.c1id )" + 
                                                " SELECT cid2cname(c1id), cid2cname(c2id) FROM chained_coauditions;";
                                        ResultSet myResultSet = DBConnection.ExecQuery(FifthQuery);
