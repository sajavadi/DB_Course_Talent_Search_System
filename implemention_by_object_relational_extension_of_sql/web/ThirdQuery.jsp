                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-dashboard"></i> 3rd query
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <tbody>
                                 <%
                                        String ThirdQuery = "SELECT cid2cname(a1.contestant), cid2cname(a2.contestant)" + 
                                            " FROM audition a1, audition a2" + 
                                            " WHERE a1.contestant != a2.contestant AND" +
                                            " a1.piece = a2.piece AND" + 
                                            " max_audition_score(a1) = max_audition_score(a2) AND" + 
                                            " judge_count(a1) >= 3 AND" +  
                                            " judge_count(a2) >= 3 AND" + 
                                            " a1.contestant > a2.contestant;" ;
                                        ResultSet myResultSet = DBConnection.ExecQuery(ThirdQuery);
